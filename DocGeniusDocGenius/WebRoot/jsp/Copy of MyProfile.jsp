...
<body>
	...
	<div id="header">
		<div id="menu">
			<ul>
				<li ><a href="MyDocuments.jsp" class="first">我的论文</a></li>
	...
	<div id="page">
		<div id="content">
		  <div class="post">
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>>
				<td><INPUT class="title1"   type=text value="专杀学霸" ></td>
				</tr>
			...
			<div class="post">
				<tr>
				<td class="title2">邮箱：</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>>
				<td><INPUT class="title3"   type=text value="zhuanshaxueba@163.com" ></td>
				</tr>
