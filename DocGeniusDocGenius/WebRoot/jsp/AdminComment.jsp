...
<link href="css/AdminComment.css" rel="stylesheet" type="text/css" media="screen" />
</head>
<body>
	...
	<div id="header">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="AdminComment.jsp">详细评价</a></li>
		       ...
		       <tr>
		          <td>
		             <select name="文献分类" class="select" onchange="selChange(this)" style="margin-left:0px; border:1px medium #000066; border-color:#FFFFFF">
					             <option value="0" style="font-size:15px;"  selected="selected">请选择详细评价信息</option>
					             <option value="1" style="font-size:15px;">解决的问题</option>
					             <option value="2" style="font-size:15px;">主要思路</option>
					             <option value="3" style="font-size:15px;">实验结果</option>
					             <option value="4" style="font-size:15px;">贡献</option>
					             <option value="5" style="font-size:15px;">改进</option>  
			         </select>
			      </td>
			      <td>
			      ...
			      <td>
			         <s:submit style=" " value="删除该条信息" style="margin-left:25px;"></s:submit>
			      </td>
		    </tr>
		    <tr>
			      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript" >
    ...
    function selChange(obj)
    {
        ...
        //alert(value);
        if(value == 1){//图书
            document.getElementById("text").value = "解决的问题";
        }
        if(value == 2){//图书章节
            document.getElementById("text").value = "主要思路";
        }
        if(value == 3){//期刊
            document.getElementById("text").value = "实验结果";
        }
        if(value == 4){//会议
            document.getElementById("text").value = "贡献";
        }
        if(value == 5){//学位论文
            document.getElementById("text").value = "改进";
        }
        if(value == 6){//技术报告
