			...
			<s:form action="uploadFile" method="post" enctype="multipart/form-data">
				<div class="entry2">
					...
					<p style="margin-left:100px; color:#FFFFFF">
					    <tr>
					        <td>选择文献分类</td>
					        <s:hidden id = "paperType" name = "selectedType"></s:hidden>
					        <td>
					        <select id="selectType" name="文献分类" class="select" onchange="selChange(this)" style="margin-left:100px; border:1px medium #000066; border-color:#FFFFFF">
					...
					<p class="title4">
						标签:&nbsp;&nbsp;&nbsp;&nbsp;
						<s:textfield cssClass="title1.1" name="paper.tips"></s:textfield>
						<!--<INPUT class="title1.1" type=text value="">-->
							<!--<INPUT class="title1.1" type=text value="">-->
					</p>
...
*/
    ...
    function setSelectValue(){
    	...
    	var value = <%=request.getParameter("selectedType")%>;
    	alert(value);
