...
<link href="css/AdminQuote.css" rel="stylesheet" type="text/css" media="screen" />
</head>
<body>
	...
	<div id="header">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="AdminQuote.jsp">引用关系</a></li>
			</ul>
		</div>
		<!-- end #menu -->
		<div id="search">
		       ...
		       <tr>
		          <td>
		             <select name="文献分类" class="select" onchange="selChange(this)" style="margin-left:0px; border:1px medium #000066; border-color:#FFFFFF">
					             <option value="0" style="font-size:15px;"  selected="selected">请选择引用类型</option>
					             <option value="1" style="font-size:15px;">简单提及</option>
					             <option value="2" style="font-size:15px;">相关</option>
					             <option value="3" style="font-size:15px;">使用</option>
					             <option value="4" style="font-size:15px;">对比</option>
					             <option value="5" style="font-size:15px;">不确定</option>  
			         </select>
			      </td>
			      <td>
			      ...
			      <td>
			         <s:submit style=" " value="删除该引用关系" style="margin-left:25px;"></s:submit>
			      </td>
		    </tr>
		    <tr>
			      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript" >
    ...
    function selChange(obj)
    {
        ...
        //alert(value);
        if(value == 1){//图书
            document.getElementById("text").value = "简单提及";
        }
        if(value == 2){//图书章节
            document.getElementById("text").value = "相关";
        }
        if(value == 3){//期刊
            document.getElementById("text").value = "使用";
        }
        if(value == 4){//会议
            document.getElementById("text").value = "对比";
        }
        if(value == 5){//学位论文
            document.getElementById("text").value = "不确定";
        }
        if(value == 6){//技术报告
